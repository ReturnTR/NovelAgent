...
class SessionManager:
    ...
    def append_message(self, session_id: str, role: str, content: str, tool_calls: Optional[List[Dict]] = None, tool_results: Optional[List[Dict]] = None, tool_call_id: Optional[str] = None, reasoning_content: Optional[str] = None):
        """追加消息到会话文件"""
        session_file = self.base_dir / f"{session_id}.jsonl"
        ...
        # 跳过空消息（既没有内容也没有工具调用也没有reasoning）
